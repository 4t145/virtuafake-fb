...
export type Form = Omit<Api.Liveroom.Danmaku.Req, 'pagination'>;
    ...
    <v-container>
      ...
      <v-row>
        <v-col md="3" sm="6" xs="12">
          <v-switch label="屏蔽表情" color="vrpink" v-model="form.no_emoticon"></v-switch>
        </v-col>
        <v-col md="3" sm="6" xs="12">
          <v-switch label="屏蔽抽奖" color="vrpink" v-model="form.no_draw"></v-switch>
        </v-col>
      </v-row>
    </v-container>
  </v-form>
